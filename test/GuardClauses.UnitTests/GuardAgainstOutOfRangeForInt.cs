...
public class GuardAgainstOutOfRangeForInt
{
    ...
    {
        var exception = Assert.Throws<GuardOutOfRangeException>(() => Guard.Against.OutOfRange(3, "parameterName", 0, 1, customMessage));
    ...
    {
        var exception = Assert.Throws<GuardOutOfRangeException>(() => Guard.Against.OutOfRange(3, expectedParamName, 0, 1, customMessage));
        Assert.NotNull(exception);
