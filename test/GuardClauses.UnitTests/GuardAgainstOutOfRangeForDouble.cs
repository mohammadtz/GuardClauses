...
public class GuardAgainstOutOfRangeForDouble
{
    ...
    {
        var exception = Assert.Throws<GuardOutOfRangeException>(() => Guard.Against.OutOfRange(3.0d, "parameterName", 0.0d, 1.0d, customMessage));
    ...
    {
        var exception = Assert.Throws<GuardOutOfRangeException>(() => Guard.Against.OutOfRange(3.0d, expectedParamName, 0.0d, 1.0d, customMessage));
        Assert.NotNull(exception);
